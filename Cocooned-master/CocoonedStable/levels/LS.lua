...
local function load(mapData, map, rune, objects, wisp, water, wall, auraWall)
	...
	if mapData.pane == "LS" then
		...
		if mapData.world == "A" then
			...
			objects["exitPortal2"].x, objects["exitPortal3"].y = generate.tilesToPixels(14, 12)		
			objects["exitPortal3"].x, objects["exitPortal3"].y = generate.tilesToPixels(20.5, 11)
			objects["exitPortal4"].x, objects["exitPortal5"].y = generate.tilesToPixels(28, 12)
			objects["exitPortal5"].x, objects["exitPortal6"].y = generate.tilesToPixels(31, 15)
		...
		elseif mapData.world == "C" then
			...
			objects["exitPortal12"].x, objects["exitPortal12"].y = generate.tilesToPixels(20.5, 11)
			objects["exitPortal13"].x, objects["exitPortal13"].y = generate.tilesToPixels(28, 12)
