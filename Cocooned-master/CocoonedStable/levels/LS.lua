...
local function load(mapData, map, rune, objects, wisp, water, wall, auraWall, players, player)
	...
	if mapData.pane == "LS" then
		...
		if mapData.world == "A" then
			...
			objects["exitPortal2"].x, objects["exitPortal2"].y = generate.tilesToPixels(20.5, 21.5) --(14, 12)		
			...
			objects["worldPortal1"].x, objects["worldPortal1"].y = generate.tilesToPixels(14, 12)		--(20.5, 21.5)
