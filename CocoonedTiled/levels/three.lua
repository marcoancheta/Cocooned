...
local function load(pane, map, rune, objects, wisp, water, wall, auraWall)
	...
	if pane == "M" then
		...
		-- Pink rune
		rune[4].x, rune[4].y = map.tilesToPixels(3, 2)			
		rune[4].isVisible = true
			
		objects["exitPortal1"]:setSequence("still")
		objects["exitPortal1"].x, objects["exitPortal1"].y = map.tilesToPixels(37, 11)
		
		wisp[1].x, wisp[1].y = map.tilesToPixels(3, 4)
		wisp[2].x, wisp[2].y = map.tilesToPixels(3, 8)
		wisp[3].x, wisp[3].y = map.tilesToPixels(3, 16)
		wisp[4].x, wisp[4].y = map.tilesToPixels(3, 21)
		wisp[5].x, wisp[5].y = map.tilesToPixels(12, 11)
		wisp[6].x, wisp[6].y = map.tilesToPixels(19, 11)
		wisp[6].x, wisp[6].y = map.tilesToPixels(25, 11)
		wisp[6].x, wisp[6].y = map.tilesToPixels(33, 11)
	...
	generate.gObjects(three, objects, map, pane, rune)
	-- generate all moveable objects in pane when locations are set
	mObjects = generate.gMObjects(three, objects, map, pane)
